...
SELECT BID,TITLE,CONTENT,MNAME FROM BOARD LEFT OUTER JOIN MEMBER ON BOARD.WRITER = MEMBER.MID ORDER BY BID DESC; 
SELECT BID,TITLE,CONTENT,MNAME FROM BOARD JOIN MEMBER ON BOARD.WRITER = MEMBER.MID ORDER BY BID DESC; 
SELECT * FROM BOARD JOIN MEMBER ON BOARD.WRITER = MEMBER.MID ORDER BY BID DESC; 
